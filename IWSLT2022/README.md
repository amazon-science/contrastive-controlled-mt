...
We will provide and evaluation sript `scorer.py` (COMING SOON) for computing the `matched-formal` and `matched-informal` accuracy scores for a given system output. Requires python>=3.7.
